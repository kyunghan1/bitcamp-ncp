...
public class Exam0110 {
  ...
  public static void main(String[] args) {
    ...
    A.m1();  // 스태틱 맴버를 사용할 때는 인스턴스가 없더도 된다
    //A.m2();  // 인스턴스 맴버를 사용하려면 반드시 해당 객체가 있어야 한다
    ...
    // non static 메서드를 호출 하려면 인스턴스 주소가 필요하듯이
    outer.m2();

    //2)inner class의 인스턴스를 생성할 때도 바깥 클래스의 인스터스 주소가 필요하다
    obj = outer.new X();
