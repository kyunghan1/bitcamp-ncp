...
public class Exam0150 {
  ...
  public static void main(String[] args) {
    ...
    //
    // HashSet
    // => 값을 저장할때 해시값을 계산하여 저장 위치를 알아낸다
    //      집합방식으로 목록을 다룬다 즉 중복 값을 저장하지 않는다
    //      저장과정 =
    //          1. equals()와 hashCode()를 호출하여 중복 여부를 검사한다
    //          2. equals()의 리턴 값도 true 이고 hashCode()의 리턴 값도 같은 경우
    //              같은 객체로 판단하여 저장하지 않는다
    //              리턴값이 true 라면 같은 객체로 간주하여 저장하지 않는다
    //              리턴값이 false 라면 다른 객체로 간주하여 저장한다
    //          3. 저장할때 저장위치는 hashCode()의 리턴 값을 사용하여 계산한다
